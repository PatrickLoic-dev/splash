  ...
  return (
    <svg width={size} height={size} viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
      <g transform="matrix(.061615 0 0 .061615 -1.430818 -1.2754)">
        <defs>
          <path id="flA" d="M959.4 500L679.8 779.7l279.6 279.7H639.9L360.2 779.7 639.9 500h319.5zM639.9 20.7L120.6 540l159.8 159.8 679-679.1H639.9z"/>
        </defs>
        ...
        <defs>
          <path id="flC" d="M959.4 500L679.8 779.7l279.6 279.7H639.9L360.2 779.7 639.9 500h319.5zM639.9 20.7L120.6 540l159.8 159.8 679-679.1H639.9z"/>
        </defs>
        <clipPath id="flD"><use href="#flC"/></clipPath>
        <path clipPath="url(#flD)" d="M639.9 20.7h319.5l-679 679.1L120.6 540z" fill="#39cefd"/>
        <defs>
          <path id="flE" d="M959.4 500L679.8 779.7l279.6 279.7H639.9L360.2 779.7 639.9 500h319.5zM639.9 20.7L120.6 540l159.8 159.8 679-679.1H639.9z"/>
        </defs>
        <clipPath id="flF"><use href="#flE"/></clipPath>
        <path clipPath="url(#flF)" d="M520 939.5l119.9 119.8h319.5L679.8 779.7z" fill="#03569b"/>
        <g clipPath="url(#flB)">
...
function ReactNativeLogo({ size = 28 }: { size?: number }) {
  // Use the React atom logo (React Native uses the same mark)
  return (
    <svg width={size} height={size} viewBox="-11.5 -10.23174 23 20.46348" xmlns="http://www.w3.org/2000/svg">
      <circle cx="0" cy="0" r="2.05" fill="#61dafb"/>
      <g stroke="#61dafb" strokeWidth="1" fill="none">
